...
contract StableCoin is ERC20, AccessControl, Pausable, ReentrancyGuard {
    ...
    function setWhitelistReceiverPolicy(bool enforceForReceivers) external onlyRole(ADMIN_ROLE) {
    ...
    function withdraw(uint256 amount, address withdrawer, bytes32 data) external onlyRole(BURNER_ROLE) nonReentrant {
